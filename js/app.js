...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 默认选中资源
        selectedAPIs = ["tyyszy", "bfzy", "dyttzy", "ruyi" , 'dyttzy', 'ruyi', 'bfzy', 'tyyszy', 'xiaomaomi', 'ffzy', 'heimuer', 'zy360', 'iqiyi', 'wolong', 'hwba', 'jisu', 'dbzy', 'mozhua', 'mdzy', 'zuid', 'yinghua', 'baidu', 'wujin', 'wwzy', 'ikun', 'lzi' ];
